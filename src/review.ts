...
style.textContent = `:root{--ext-text:var(--neo-text,#26364a);--ext-muted:var(--neo-surface-muted,#d7dde6);--ext-primary:var(--neo-primary,#4279ad);--ext-danger:var(--neo-danger,#a33a2d);color-scheme:light dark;font:var(--neo-font-size,16px)/1.3 var(--neo-font-family,system-ui,sans-serif)}:root[data-theme=dark]{--ext-text:var(--neo-text,#e7edf5);--ext-muted:var(--neo-surface-muted,#3e4a5c);--ext-danger:var(--neo-danger,#ff9a8d)}*{box-sizing:border-box}body{margin:0;background:transparent;color:var(--ext-text)}.timer{display:flex;align-items:center;gap:8px;min-height:44px;padding:4px}.value{min-width:3.25rem;font-variant-numeric:tabular-nums;font-weight:750}.track{display:block;width:min(96px,28vw);height:6px;overflow:hidden;border-radius:999px;background:var(--ext-muted)}.track span{display:block;height:100%;background:var(--ext-primary);transition:transform .2s linear;transform-origin:left}.timer.urgent .value{color:var(--ext-danger)}.timer.urgent .track span{background:var(--ext-danger)}.announcement{position:absolute;width:1px;height:1px;overflow:hidden;clip-path:inset(50%);white-space:nowrap}@media(prefers-reduced-motion:reduce){.track span{transition:none}}`
